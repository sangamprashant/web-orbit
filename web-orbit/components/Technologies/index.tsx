            ...
            <div className="container mx-auto px-6 overflow-hidden">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-400">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto quia harum fugiat voluptates eveniet labore, excepturi nesciunt ullam molestias similique sequi quidem, illo perferendis accusantium facilis nisi fuga voluptatibus possimus.
                    </p>
                </div>
        ...
        <div className='technologies mt-10'>
            <div className="container-technologies active">
                ...
                <ul className="menu">
                    ...
                    <TechnologyItem icon={SiNextdotjs} title="Next.js" index={5} onClick={handleTechClick} selectedTech={selectedTech} />
