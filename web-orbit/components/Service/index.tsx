          ...
          {services.map((service, index) => (
            ...
            >
              <div className="glass-effect bg-opacity-20 backdrop-filter backdrop-blur-md p-4 rounded-lg shadow-md service-card">
                <div className="w-16 h-16 inline-flex items-center justify-center rounded-2xl bg-indigo-100 text-orange-100 mb-4 flex-shrink-0 p-2">
